"""
Django settings for kolik_47953 project.
...
WSGI_APPLICATION = 'kolik_47953.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kolik_47953 API",
    "DESCRIPTION": "API documentation for kolik_47953 App",
    "VERSION": "v1",
}
